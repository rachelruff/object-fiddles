...
let makePerson = (name, birthday, ssn) => {return {name, birthday, ssn}};
...
let makeCard = (cardNumber, expirationDate, securityCode) => {return {cardNumber, expirationDate, securityCode}};
